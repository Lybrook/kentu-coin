        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <p className="text-sm font-mono text-[#003153]">0x1234...5678</p>
            </div>
            <div className="w-10 h-10 rounded-full bg-[#003153] text-[#FFC72C] flex items-center justify-center font-bold">
              JD
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg border-2 border-[#003153]/20 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <Wallet className="h-5 w-5 text-[#FFC72C]" />
            </div>
        ...
        <div className="bg-white rounded-lg border-2 border-[#003153]/20 p-6 shadow-sm mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Button className="bg-[#FFC72C] hover:bg-yellow-500 text-[#003153] font-semibold py-6 h-auto flex flex-col items-center gap-2">
        ...
        <div className="bg-white rounded-lg border-2 border-[#003153]/20 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <Activity className="h-5 w-5 text-[#003153]" />
          </div>
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                <div>
                  <p className="font-semibold text-[#003153]">{activity.type}</p>
                  <p className="text-xs text-gray-600">{activity.time}</p>
                </div>
                <p className="font-semibold text-[#003153]">{activity.amount}</p>
              </div>
            ))}
          </div>
        </div>
