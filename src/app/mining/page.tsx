      ...
      <header className="bg-white border-b border-evergreen/10 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-evergreen">Active: 2/3</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg border-2 border-evergreen/20 p-6 shadow-sm">
            ...
            <p className="text-2xl font-bold text-evergreen" style={{ fontFamily: "var(--font-serif)" }}>
              223.8 MH/s
            </p>
          </div>
          <div className="bg-white rounded-lg border-2 border-evergreen/20 p-6 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          {rigs.map((rig) => (
            <div key={rig.id} className="bg-white rounded-lg border-2 border-evergreen/20 p-6 shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-6 gap-4 items-center">
                <div>
                  <h3 className="font-bold text-evergreen">{rig.name}</h3>
                ...
                <div className="flex items-center gap-2">
                  <Cpu className="h-4 w-4 text-evergreen" />
                  <div>
                    <p className="text-xs text-gray-600">Hash Rate</p>
                    <p className="font-semibold text-evergreen">{rig.hashRate}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-evergreen">{rig.power}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-evergreen">{rig.temp}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gold">{rig.earnings}</p>
                  </div>
                </div>
